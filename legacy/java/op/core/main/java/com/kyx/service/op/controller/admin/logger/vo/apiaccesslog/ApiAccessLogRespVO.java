package com.kyx.service.op.controller.admin.logger.vo.apiaccesslog;

import com.kyx.foundation.excel.core.annotations.DictFormat;
import com.kyx.foundation.excel.core.convert.DictConvert;
import com.kyx.service.op.enums.DictTypeConstants;
...
public class ApiAccessLogRespVO {
    ...
    @DictFormat(com.kyx.service.op.enums.DictTypeConstants.OPERATE_TYPE)
    ...
    @Schema(description = "结果提示", example = "MK，牛逼！")
    @ExcelProperty("结果提示")
