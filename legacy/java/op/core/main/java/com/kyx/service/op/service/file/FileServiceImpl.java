...
import com.kyx.service.op.dal.mysql.file.FileMapper;
import com.kyx.service.op.framework.file.core.client.FileClient;
import com.kyx.service.op.framework.file.core.client.s3.FilePresignedUrlRespDTO;
import com.kyx.service.op.framework.file.core.utils.FileTypeUtils;
...
import static com.kyx.service.op.enums.ErrorCodeConstants.FILE_NOT_EXISTS;
...
public class FileServiceImpl implements FileService {
    ...
    @Override
    public byte[] getFileContentByFileId(String fileId) throws Exception {
        // 通过 fileId 查询文件记录
        FileDO file = fileMapper.selectOne(FileDO::getFileId, fileId);
    ...
    @Override
    public FileDO getFileByFileId(String fileId) {
        return fileMapper.selectOne(FileDO::getFileId, fileId);
    }
