package com.kyx.service.op.service.codegen.inner;
...
import com.kyx.foundation.apilog.core.enums.OperateTypeEnum;
...
import com.kyx.service.op.dal.dataobject.codegen.CodegenColumnDO;
import com.kyx.service.op.dal.dataobject.codegen.CodegenTableDO;
import com.kyx.service.op.enums.codegen.CodegenFrontTypeEnum;
import com.kyx.service.op.enums.codegen.CodegenSceneEnum;
import com.kyx.service.op.enums.codegen.CodegenTemplateTypeEnum;
import com.kyx.service.op.enums.codegen.CodegenVOTypeEnum;
import com.kyx.service.op.framework.codegen.config.CodegenProperties;
...
public class CodegenEngine {
    ...
    /**
     * 是否为 foundation-cloud 项目，用于解决 Boot 和 Cloud 的 api 模块兼容性问题
     *
     * true  - 需要有 foundation-module-xxx-api 模块
    ...
    public CodegenEngine() {
        ...
        this.cloudEnable = ClassUtils.isPresent("com.kyx.service.op.framework.rpc.config.RpcConfiguration",
    ...
    private Map<String, String> getTemplates(Integer frontType) {
        ...
        if (Boolean.FALSE.equals(cloudEnable)) {
            SERVER_TEMPLATES.forEach((templatePath, filePath) -> {
                filePath = StrUtil.replace(filePath, "/foundation-module-${table.moduleName}-api", "");
                filePath = StrUtil.replace(filePath, "/foundation-module-${table.moduleName}-server", "");
    ...
    private static String javaModuleFilePath(String path, String module, String src) {
        return "foundation-module-${table.moduleName}/" + // 顶级模块
                "foundation-module-${table.moduleName}-" + module + "/" + // 子模块
                "src/" + src + "/java/${basePackage}/module/${table.moduleName}/" + path + ".java";
    }

    private static String mapperXmlFilePath() {
        return "foundation-module-${table.moduleName}/" + // 顶级模块
                "foundation-module-${table.moduleName}-server/" + // 子模块
    ...
    private static String vueFilePath(String path) {
        return "foundation-ui-${sceneEnum.basePackage}-vue2/" + // 顶级目录
                "src/" + path;
    }
    ...
    private static String vue3FilePath(String path) {
        return "foundation-ui-${sceneEnum.basePackage}-vue3/" + // 顶级目录
                "src/" + path;
    }
