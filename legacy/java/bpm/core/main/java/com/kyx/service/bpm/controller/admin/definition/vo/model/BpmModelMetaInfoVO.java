package com.kyx.service.bpm.controller.admin.definition.vo.model;

import com.kyx.foundation.common.core.KeyValue;
...
import com.kyx.service.bpm.enums.definition.BpmAutoApproveTypeEnum;
import com.kyx.service.bpm.enums.definition.BpmModelFormTypeEnum;
 ...
 *
 * 最终，它的字段和
 * {@link com.kyx.service.bpm.dal.dataobject.definition.BpmProcessDefinitionInfoDO}
 * 是一致的
 *
 * @author MK
 */
...
public class BpmModelMetaInfoVO {
    ...
    @Schema(description = "流程图标", example = "https://www.iocoder.cn/foundation.jpg")
    ...
    @Schema(description = "业务表单字段配置", example = "[]")
    private List<CustomFormField> customFormFields; // 表单类型为 CUSTOM 时使用
    ...
    @Schema(description = "跨租户模式", example = "0")
    @InEnum(value = com.kyx.service.bpm.enums.definition.BpmCrossTenantModeEnum.class, message = "跨租户模式必须是 {value}")
    private Integer crossTenantMode;

    @Schema(description = "可见租户ID列表", example = "[1,2,3]")
    ...
    public static class CustomFormField {
        ...
        @Schema(description = "字段标题", example = "用户名")
