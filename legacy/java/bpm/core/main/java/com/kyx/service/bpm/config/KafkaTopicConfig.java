package com.kyx.service.bpm.config;
...
public class KafkaTopicConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        log.info("Kafka主题配置已准备：{}", BPM_PROCESS_STATUS_TOPIC);
        log.info("如果主题不存在，Kafka将自动创建（需要开启auto.create.topics.enable=true）");
        log.info("或者手动创建主题：kafka-topics.sh --create --topic {} --partitions 3 --replication-factor 1", BPM_PROCESS_STATUS_TOPIC);
    }
} 