...
public class BpmProcessInstanceController {
    ...
    public CommonResult<BpmProcessInstanceRespVO> getProcessInstance(@RequestParam("id") String id) {
        // 校验权限
        validateProcessInstanceAccess(id);
    ...
    private void validateProcessInstanceAccess(String processInstanceId) {
        ...
        BpmProcessDefinitionInfoDO definitionInfo =
                processDefinitionService.getProcessDefinitionInfo(instance.getProcessDefinitionId());
        ...
        if (!processDefinitionService.hasProcessDefinitionAccess(definitionInfo, currentTenantId)) {
