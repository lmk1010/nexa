package com.kyx.service.bpm.dal.dataobject.definition;

import com.kyx.foundation.mybatis.core.dataobject.BaseDO;
import com.kyx.foundation.mybatis.core.type.LongListTypeHandler;
...
public class BpmProcessDefinitionInfoDO extends BaseDO {
     ...
     * 跨租户模式
     *
     * 枚举 {@link com.kyx.service.bpm.enums.definition.BpmCrossTenantModeEnum}
     */
     ...
     * 可见租户ID列表
     *
     * 仅在 crossTenantMode = {@link com.kyx.service.bpm.enums.definition.BpmCrossTenantModeEnum#SPECIFIED_TENANTS} 时有效
     */
    @TableField(typeHandler = LongListTypeHandler.class)
