...
public interface BpmProcessDefinitionService {
     ...
     * @return 可见的流程定义列表
     */
    List<BpmProcessDefinitionInfoDO> getVisibleProcessDefinitionList();
     ...
     * @return 是否有权限访问
     */
    boolean hasProcessDefinitionAccess(BpmProcessDefinitionInfoDO processDefinitionInfo, Long currentTenantId);
