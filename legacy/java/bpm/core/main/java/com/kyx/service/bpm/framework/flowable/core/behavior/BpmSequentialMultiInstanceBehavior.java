package com.kyx.service.bpm.framework.flowable.core.behavior;

import cn.hutool.core.collection.CollUtil;
import com.kyx.foundation.common.util.collection.SetUtils;
import com.kyx.service.bpm.enums.definition.BpmChildProcessMultiInstanceSourceTypeEnum;
...
public class BpmSequentialMultiInstanceBehavior extends SequentialMultiInstanceBehavior {
    ...
    protected void executeOriginalBehavior(DelegateExecution execution, ExecutionEntity multiInstanceRootExecution, int loopCounter) {
        // 参见 https://gitee.com/zhijiantianya/foundation-cloud/issues/IC239F
