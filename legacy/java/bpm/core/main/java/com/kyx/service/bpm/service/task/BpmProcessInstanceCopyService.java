...
public interface BpmProcessInstanceCopyService {
    ...
    List<Long> getProcessInstanceCopyUserIds(String processInstanceId);

    BpmCopyNoticeResendRespDTO resendRunningCopyDingTalkNotices(Integer limit, Boolean dryRun);
