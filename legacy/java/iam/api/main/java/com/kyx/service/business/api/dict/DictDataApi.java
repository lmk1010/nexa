package com.kyx.service.business.api.dict;

import com.kyx.foundation.common.biz.system.dict.DictDataCommonApi;
...
@FeignClient(name = ApiConstants.NAME, contextId = "dictDataApi") // TODO ：fallbackFactory =
