package com.kyx.service.business.enums;
...
public interface ErrorCodeConstants {
    ...
    ErrorCode AUTH_USER_NOT_REGISTERED = new ErrorCode(1_002_000_009, "用户未注册，请先注册");
    ErrorCode AUTH_PRE_LOGIN_TOKEN_INVALID = new ErrorCode(1_002_000_010, "登录状态已失效，请重新输入账号密码");
    ErrorCode AUTH_PRE_LOGIN_TENANT_INVALID = new ErrorCode(1_002_000_011, "请选择有效的租户后登录");
    ...
    ErrorCode ROLE_NAME_DUPLICATE = new ErrorCode(1_002_002_001, "已经存在该名字的角色");
    ...
    // ========== 定时任务管理模块 1-002-010-000 ==========
    ErrorCode SCHEDULER_TASK_NOT_EXISTS = new ErrorCode(1_002_010_000, "定时任务不存在");
    ErrorCode SCHEDULER_TASK_NAME_DUPLICATE = new ErrorCode(1_002_010_001, "已经存在该名字的定时任务");
    ErrorCode SCHEDULER_TASK_DISABLED = new ErrorCode(1_002_010_002, "定时任务已禁用");

    // ========== 定时任务日志模块 1-002-011-000 ==========
    ErrorCode SCHEDULER_LOG_NOT_EXISTS = new ErrorCode(1_002_011_000, "定时任务日志不存在");
    ...
    ErrorCode DEPT_HAS_USERS = new ErrorCode(1_002_004_008, "部门下存在员工，请先处理员工后再删除部门");
    ...
    ErrorCode NOTICE_RECEIVER_TYPE_INVALID = new ErrorCode(1_002_008_002, "通知对象类型不正确");
    ErrorCode NOTICE_RECEIVER_USER_REQUIRED = new ErrorCode(1_002_008_003, "请选择通知人员");
    ...
    ErrorCode TENANT_USER_ALREADY_BOUND = new ErrorCode(1_002_015_006, "用户已经绑定到该租户");
    ErrorCode TENANT_USER_NOT_IN_TENANT = new ErrorCode(1_002_015_007, "您无权访问该租户，请联系管理员");
    ErrorCode TENANT_USER_NOT_BOUND = new ErrorCode(1_002_015_008, "用户未绑定到该租户");
    ...
    // ========== 邀请码注册 1-002-029-000 ==========
    ErrorCode REGISTER_INVITATION_CODE_REQUIRED = new ErrorCode(1_002_029_000, "注册需要邀请码");
    ErrorCode REGISTER_INVITATION_CODE_NOT_EXISTS = new ErrorCode(1_002_029_001, "邀请码不存在");
    ErrorCode REGISTER_INVITATION_CODE_INVALID = new ErrorCode(1_002_029_002, "邀请码无效");
    ErrorCode REGISTER_INVITATION_CODE_EXPIRED = new ErrorCode(1_002_029_003, "邀请码已过期");
    ErrorCode REGISTER_INVITATION_CODE_USED_UP = new ErrorCode(1_002_029_004, "邀请码已用完");
    ErrorCode REGISTER_INVITATION_CODE_VALIDATION_FAILED = new ErrorCode(1_002_029_005, "邀请码验证失败：{}");

    // ========== 注册参数验证 1-002-030-000 ==========
    ErrorCode REGISTER_PARAM_MISSING = new ErrorCode(1_002_030_000, "注册参数缺失：{}");
    ErrorCode REGISTER_PASSWORD_REQUIRED = new ErrorCode(1_002_030_001, "密码不能为空");
    ErrorCode REGISTER_NICKNAME_REQUIRED = new ErrorCode(1_002_030_002, "昵称不能为空");
    ErrorCode REGISTER_IDENTIFIER_REQUIRED = new ErrorCode(1_002_030_003, "至少需要提供用户名、手机号或邮箱中的一种");
