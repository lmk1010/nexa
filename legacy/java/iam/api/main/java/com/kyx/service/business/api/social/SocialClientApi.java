package com.kyx.service.business.api.social;

import com.kyx.foundation.common.pojo.CommonResult;
import com.kyx.service.business.api.social.dto.*;
import com.kyx.service.business.api.social.dto.*;
...
public interface SocialClientApi {
    ...
    @Parameters({
            @Parameter(name = "userType", description = "用户类型", example = "1", required = true),
            @Parameter(name = "phoneCode", description = "手机授权码", example = "foundation11", required = true)
    })
