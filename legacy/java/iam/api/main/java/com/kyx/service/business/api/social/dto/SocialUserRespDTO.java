package com.kyx.service.business.api.social.dto;
...
public class SocialUserRespDTO {
    ...
    @Schema(description = "社交用户的昵称", requiredMode = Schema.RequiredMode.REQUIRED, example = "MK")
    ...
    @Schema(description = "社交用户手机号", example = "13800138000")
    private String mobile;

    public SocialUserRespDTO(String openid, String nickname, String avatar, Long userId) {
        this.openid = openid;
