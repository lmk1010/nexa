package com.kyx.service.business.controller.admin.socail.vo.user;
...
public class SocialUserRespVO {
    ...
    @Schema(description = "是否已绑定 OA 用户", example = "true")
    private Boolean bound;

    @Schema(description = "绑定的 OA 用户 ID", example = "1024")
    private Long userId;

    @Schema(description = "绑定的 OA 用户名", example = "admin")
