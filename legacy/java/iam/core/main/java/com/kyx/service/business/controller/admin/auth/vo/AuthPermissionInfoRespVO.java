...
public class AuthPermissionInfoRespVO {
    ...
    @Schema(description = "是否有角色权限（用于判断是否显示无权限提示）", requiredMode = Schema.RequiredMode.REQUIRED, example = "true")
    ...
    public static class UserVO {
        ...
        @Schema(description = "用户昵称", requiredMode = Schema.RequiredMode.REQUIRED, example = "MK")
