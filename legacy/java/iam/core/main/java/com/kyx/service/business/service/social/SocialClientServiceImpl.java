package com.kyx.service.business.service.social;
...
import com.kyx.foundation.common.util.cache.CacheUtils;
import com.kyx.foundation.common.util.http.HttpUtils;
import com.kyx.foundation.common.util.object.BeanUtils;
import com.kyx.service.business.api.social.dto.SocialWxQrcodeReqDTO;
import com.kyx.service.business.api.social.dto.SocialWxaOrderNotifyConfirmReceiveReqDTO;
import com.kyx.service.business.api.social.dto.SocialWxaOrderUploadShippingInfoReqDTO;
import com.kyx.service.business.api.social.dto.SocialWxaSubscribeMessageSendReqDTO;
import com.kyx.service.business.controller.admin.socail.vo.client.SocialClientPageReqVO;
import com.kyx.service.business.controller.admin.socail.vo.client.SocialClientSaveReqVO;
import com.kyx.service.business.dal.dataobject.social.SocialClientDO;
import com.kyx.service.business.dal.mysql.social.SocialClientMapper;
...
import static com.kyx.foundation.common.util.collection.MapUtils.findAndThen;
import static com.kyx.foundation.common.util.date.LocalDateTimeUtils.UTC_MS_WITH_XXX_OFFSET_FORMATTER;
...
public class SocialClientServiceImpl implements SocialClientService {
     ...
     * 3. developer：开发版
     */
    @Value("${foundation.wxa-code.env-version:release}")
     ...
     * 3. formal：正式版
     */
    @Value("${foundation.wxa-subscribe-message.miniprogram-state:formal}")
    public String miniprogramState;

    //    @Resource
    @Autowired // TODO @：等 justauth1.4.1 发布，可以去掉
    ...
    public String getAuthorizeUrl(Integer socialType, Integer userType, String redirectUri) {
        ...
        return UriComponentsBuilder.fromUriString(authorizeUri)
                .replaceQueryParam("redirect_uri", redirectUri)
                .build()
                .encode()
                .toUriString();
    }
