package com.kyx.service.business.controller.admin.socail.vo.client;
...
public class SocialClientRespVO {
    ...
    @Schema(description = "应用名", requiredMode = Schema.RequiredMode.REQUIRED, example = "foundation商城")
    private String name;
