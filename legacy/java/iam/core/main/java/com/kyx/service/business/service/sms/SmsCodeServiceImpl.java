...
import com.kyx.service.business.dal.dataobject.sms.SmsCodeDO;
import com.kyx.service.business.dal.mysql.sms.SmsCodeMapper;
import com.kyx.service.business.enums.sms.SmsSceneEnum;
import com.kyx.service.business.framework.sms.config.SmsCodeProperties;
...
import static com.kyx.foundation.common.util.date.DateUtils.isToday;
...
public class SmsCodeServiceImpl implements SmsCodeService {
    ...
    private String createSmsCode(String mobile, Integer scene, String ip) {
        ...
        if (lastSmsCode != null) {
            if (LocalDateTimeUtil.between(DateUtil.toLocalDateTime(lastSmsCode.getCreateTime()), LocalDateTime.now()).toMillis()
