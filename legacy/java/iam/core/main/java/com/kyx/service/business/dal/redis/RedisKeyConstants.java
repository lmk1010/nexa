package com.kyx.service.business.dal.redis;
...
public interface RedisKeyConstants {
     ...
     * 预登录令牌缓存
     *
     * KEY 格式：auth_pre_login_token:{token}
     * VALUE 数据类型：String 预登录信息
     */
    String AUTH_PRE_LOGIN_TOKEN = "auth_pre_login_token:%s";

    /**
     * 社交登录浏览器握手缓存
     *
     * KEY 格式：auth_social_browser_handoff:{handoffId}
     * VALUE 数据类型：String 浏览器接力登录信息
     */
    String AUTH_SOCIAL_BROWSER_HANDOFF = "auth_social_browser_handoff:%s";
