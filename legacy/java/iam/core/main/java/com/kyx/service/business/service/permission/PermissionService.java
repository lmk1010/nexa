...
public interface PermissionService {
    ...
    /**
     * 获得角色们拥有的菜单编号集合
     * 当角色包含超级管理员时，优先复用外部已加载的全量菜单编号，避免重复查询菜单表
     *
     * @param roleIds 角色编号数组
     * @param allMenuIdsSupplier 全量菜单编号提供器
     * @return 菜单编号集合
     */
    default Set<Long> getRoleMenuListByRoleId(Collection<Long> roleIds, Supplier<Set<Long>> allMenuIdsSupplier) {
    ...
    /**
     * 追加用户角色（追加模式：只添加新角色，不删除已有角色）
     *
     * @param userId  用户编号
     * @param roleIds 角色编号集合
     */
    void appendUserRoles(Long userId, Set<Long> roleIds);
